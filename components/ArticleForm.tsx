                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex space-x-2">
                          ...
                          <button
                            ...
                            disabled={isScanningLinks || provider === AIProvider.DEEPSEEK}
                            title={provider === AIProvider.DEEPSEEK ? 'Disabled: Web scanning is skipped when DeepSeek is selected' : 'Rescan Website'}
